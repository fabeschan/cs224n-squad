...
def load_data(data_dir, data_subset):
    ...
    with open(path + ".span") as f:
        for line in f:
            ...
            A_start.append(start_index) # [0, 0, ..., start_index] will be padded  to 1-hot vec of max_answer_size i.e. max_context_size
            A_end.append(end_index)  # [0, 0, ..., end_index] will be padded  to a 1-hot vec of max_answer_size i.e. max_context_size
    ...
    with open(path + ".answer") as f:
        for line in f:
            A_raw.append(line)
    return Q, P, A_start, A_end, P_raw, A_raw
